...
\begin{figure}[h]\centering
  ...
  \caption{\textbf{The chromosome-1 recombination landscape, and what the LD-based map does not resolve.}
    \textbf{(a)}~ReLERNN estimate in 15~kb windows with 95\% bootstrap CIs and a 0.6-Mb rolling median
    ...
    landscape is in part an estimator ceiling. \textbf{(b)}~Nucleotide diversity $\pi$ in 10~kb windows halves on the flank of
