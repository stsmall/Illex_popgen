...
\begin{figure}[h]\centering
  ...
  \caption{\textbf{Per-chromosome diversity.} Distribution of nucleotide diversity $\pi$ (top) and Tajima's
    $D$ (bottom) across 50~kb windows, one box per chromosome (pooled over the ten NAFO divisions; all 43
    chromosomes: 41 autosomes plus chr2 and chrZ). Diversity is uniform and $D$ is strongly negative genome-wide, the signature of
