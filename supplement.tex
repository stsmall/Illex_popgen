...
\begin{figure}[h]\centering
  ...
  \caption{\textbf{Per-chromosome diversity.} Distribution of nucleotide diversity $\pi$ (top) and Tajima's
    $D$ (bottom) across 50~kb windows, one box per chromosome (pooled over the ten NAFO divisions; 32
    chromosomes computed). Diversity is uniform and $D$ is strongly negative genome-wide, the signature of
