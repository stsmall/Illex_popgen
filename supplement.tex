...
\begin{figure}[h]\centering
  ...
  \caption{\textbf{Recombination, gene proximity and the efficacy of selection.} Per-window statistics
    ...
    \emph{gene-density-driven}. \textbf{(d)}~There is \emph{no} diversity--recombination relationship
    ($\rho\approx0$), unlike \textit{Drosophila} and humans, because recombination is nearly uniform
    genome-wide (0.2--0.24~cM/Mb) and cannot organise diversity here. Linked selection in \illex{} is thus
    structured by gene density and gene proximity rather than by the recombination-rate axis.}
